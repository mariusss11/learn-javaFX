...
import static com.example.javafx.Constants.*;

public class Lesson5Application extends Application {
    ...
    private void changeText() {
        text.setFont(Font.font(comboBox.getValue().toString()));
    ...
    private void createTextPanel() {
        ...
        labelFont = createLabel("Font: ", 30, 10);
        textPanel.getChildren().add(labelFont);


        comboBox = createComboBox(30 ,30);
        textPanel.getChildren().add(comboBox);
    ...
    private ComboBox createComboBox(int x, int y) {
        ...
        comboBoxToCreate.getItems().add(FONT_1);
        comboBoxToCreate.getItems().add(FONT_2);
        comboBoxToCreate.getItems().add(FONT_3);
        comboBoxToCreate.getItems().add(FONT_4);
        comboBoxToCreate.setLayoutX(x);
        comboBoxToCreate.setLayoutY(y);
